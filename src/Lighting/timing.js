...
import Random, {getNextSeed, valueFromSeed} from "../Helpers/Random.js"
...
Timing.prototype.tick = function(lighting){
    ...
    if ((lighting.Transition.Paused || lighting.Transition.Mode === TransitionMode.OFF)
        && (lighting.Fade.Paused || lighting.Fade.Mode === FadeMode.OFF)){
        return;
    }

    this.tickCount++; // should I have a separate tick for fade vs transition?

    //console.log(this.tickCount);

    if (!lighting.Fade.Paused) {
