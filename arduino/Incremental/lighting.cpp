...
void Lighting::set_fadeflickeractivation(uint8_t value){_fade.set_flickeractivation(value);}
void Lighting::set_transitionflickeractivation(uint8_t value){_transition.set_flickeractivation(value);}
